...
class FlipDataInput(BaseModel):
    ...
    length: int = Field(..., ge=2, le=8, description="Integer length between 2 and 8 inclusive.")
    streak: int = Field(..., ge=1, le=8, description="Integer streak between 1 and 8 inclusive.")
